...
const Navbar = () => {
 ...
 <li>
  ...
  return (
    <>
      <div className={`max-w-screen-2xl z-50 container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0  ${sticky? "sticky-navbar shadow-md bg-gray-100 duration-300 transition-all ease-in-out": "" }`}>
  ...
  <div className="navbar-start">
    ...
    <a className=" text-2xl text-black font-bold cursor-pointer">bookstore</a>
  </div>
  ...
  <input type="text" className="outline-none bg-white" placeholder="Search" />
